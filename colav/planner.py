    ...
    def get(
        ...
        **kwargs
        ...
        for k in range(self.max_iter + self.abort_colregs_after_iter):
            ...
            self.projector.v_des = ((1-discount_power / self.max_iter)**exponent_v_des_of_iter) * self.desired_speed + v_min * (discount_power / self.max_iter)**(1/exponent_v_des_of_iter)
